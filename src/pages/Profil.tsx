...
function ProfilLogged() {
  ...
  return (
    <div className="max-w-lg lg:max-w-4xl mx-auto min-h-full animate-fade-in pb-32">
      {/* Header */}
      ...
      {/* Sections rapides (style app Android) */}
      <div className="px-4 mt-4 space-y-4">
        <section>
          <h2 className="text-lg font-bold text-foreground mb-2">Mon activité</h2>
          <div className="rounded-2xl bg-card border border-border overflow-hidden">
            <button onClick={() => navigate('/affaires')} className="w-full flex items-center gap-3 p-3 hover:bg-muted/40 transition text-left">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Affaires</p>
                <p className="text-xs text-muted-foreground">Portefeuille, matches et carte de visite</p>
              </div>
            ...
            <button onClick={() => setActiveTab('annonces')} className="w-full flex items-center gap-3 p-3 hover:bg-muted/40 transition text-left">
              <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center"><Bookmark className="h-5 w-5 text-primary" /></div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Favoris</p>
                <p className="text-xs text-muted-foreground">Vos annonces enregistrées et synchronisées</p>
              </div>
              <ChevronRight className="h-4 w-4 text-muted-foreground" />
            </button>
          </div>
