          ...
          <CardContent className="p-5">
            ...
            <button
              ...
              onClick={async () => {
                ...
                if (r.error) {
                  toast({ title: 'Erreur Google', description: 'Connexion Google impossible. Réessayez.', variant: 'destructive' });
                  setIsLoading(false);
                }
                // if redirected, browser navigates away
              }}
              className="w-full flex items-center justify-center gap-2 rounded-xl border border-border bg-card hover:bg-muted py-2.5 text-sm font-semibold text-foreground transition mb-3"
            >
              <svg viewBox="0 0 48 48" className="h-5 w-5" aria-hidden="true">
                ...
                <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.5-5.2l-6.2-5.2C29.4 35 26.8 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.5 39.5 16.2 44 24 44z"/>
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.3-4 5.7l6.2 5.2C41 35.5 44 30.1 44 24c0-1.3-.1-2.3-.4-3.5z"/>
              </svg>
